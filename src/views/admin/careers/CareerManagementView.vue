<template>
    <h1 class="font-bold text-gray-900 dark:text-white text-4xl mb-8">Career Management Page</h1>

    <div class="mb-10">
        <router-link :to="{ name: 'career-add' }"
            class="text-white py-3 px-6 bg-primary-blue rounded-lg hover:bg-primary-orange">Add New Career</router-link>
    </div>
